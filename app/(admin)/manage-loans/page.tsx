...
import { getAccount, getAccounts, getLoanRequest } from '@/lib/actions/bank.actions';
...
const TransactionHistory = async ({ searchParams: { id, page }}:SearchParamProps) => {
  ...
  const users = await getLoanRequest();
  ...
  return (
    <div className="transactions">
      <div className="transactions-header">
        <HeaderBox 
          title="Customers Account Details"
          subtext="See customers account details."
        />
      </div>
