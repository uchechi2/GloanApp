...
import { getAccount, getAccounts, getActiveLoanList, getLoanIssuedList, getTotalBalance } from '@/lib/actions/bank.actions';
...
const TransactionHistory = async ({ searchParams: { id, page }}:SearchParamProps) => {
  ...
  const users = await getActiveLoanList();
    ...
    <div className="transactions">
      <div className="transactions-header">
        <HeaderBox 
          ...
          subtext="See customers loan details."
        />
      </div>
      ...
      <div className="space-y-6">
        <div className="transactions-account">
          ...
          <div className='transactions-account-balance'>
            <p className="text-14">Total Active Loan</p>
