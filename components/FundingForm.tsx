...
import { creditAccount, debitAccount } from '@/lib/actions/bank.actions';
import {TypeDropDown} from './TypeDropDown';

//  import createUserTable from '../lib/db/statement';


const Info = ({setShow, message}:any)=>{
  return(
    <div className= "info-container">
        <div className="info-close" onClick={()=>{setShow(false)}}>x</div>
...
const userData = {
        // account_id: ' ',
         ...
         const response = await creditAccount(userData);
        if(response === 'success')  {
          form.reset();
          router.push('/');
        }
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col">
          ...
          <p className="text-16 font-normal text-gray-600">
            Enter the bank account details of the recipient
                  ...
                  {show && <Info setShow = {setShow} message = {message}/>}  
        <FormField 
