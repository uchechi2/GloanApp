...
const AccountsTable = ({ transactions }: AccountsTableProps) => {
  return (
    <Table>
      <TableHeader className="bg-[#f9fafb]">
        <TableRow>
          ...
          <TableHead className="px-2 max-md:hidden">Date of Creation</TableHead>
      ...
      <TableBody>
        {transactions?.map((t: UserAccounts) => {
          ...
          const amount = formatAmount(t.currentBalance)
